...
# export the plot as a pdf ou svg
...
legendGradLines(pos = "topleft", # position de la légende
                title.txt = "Nb of joint communications", # titre de la légende
